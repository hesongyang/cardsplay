...
class AdminOrderController extends AdminbaseController
{
	...
	public function index()
	{
		...
		$posts = $this->plan->where($where)->order(array("id" => "desc"))->limit($page->firstRow, $page->listRows)->select();
		$this->assign('sum', $sum);
	...
	public function pk10()
	{
		...
		$page = $this->page($count, 10);
		$posts = $this->plan->where(array('type_id' => '2'))->order(array("id" => "desc"))->limit($page->firstRow, $page->listRows)->select();
		$this->assign('sum', $sum);
		$this->assign('posts', $posts);
		$this->display();
	}
	...
	public function menuOrder()
	{
		...
		$type[1] = '<span style="color:red"><b>彩种</b></span>';
