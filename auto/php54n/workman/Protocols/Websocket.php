	...
	protected static function dealHandshake($buffer, $connection)
	{
		if (0 === strpos($buffer, 'GET')) {
			...
			if (preg_match("/Sec-WebSocket-Key: *(.*?)\r\n/i", $buffer, $match)) {
				...
				$connection->send("HTTP/1.1 400 Bad Request\r\n\r\n<b>400 Bad Request</b><br>Sec-WebSocket-Key not found.<br>This is a WebSocket service and can not be accessed via HTTP.<br>See <a href=\"http://wiki.workerman.net/Error1\">http://wiki.workerman.net/Error1</a>", true);
				$connection->close();
				return 0;
			}
