...
function adduser(data){
    ...
    var html='    <div class="member member'+indexuser+'" id="user'+data.user.id+'">'
     ...
     //html+='<div id="name'+data.user.index+'" class="bscore jiurenniuniu-bname">'+data.user.dqjf+'</div></div> '
...
function jibi(data){
    ...
    setTimeout('jibiover('+win+lose+')',2500);
     ...
     //$('#member .member'+lose+' .bscore').html(data.lose.dqjf);
      $('#name'+data.win.index).html(data.win.dqjf);
  	$('#name'+data.lose.index).html(data.lose.dqjf);
