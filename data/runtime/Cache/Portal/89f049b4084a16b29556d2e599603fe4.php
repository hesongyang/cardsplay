...
.scroll li {
 ...
 <body style="background: #000;height: 100%;width: 100%;" class="onscope"> 
   ...
   <div class="noty" id="notyImg" style="width: 100vw; height: 13.8vw; background-color: rgba(0, 0, 0, 0);">
     <img src="http://goss.fexteam.com/files/images/common/gamenoty.png" style="left: 0px; top: 0px; width: 104vw; height: 13vw;">
   </div>
   
   <div class="box" id="boxboxa">
  <div class="winBox">
    <ul class="scroll">
      <li><a href="#">本游戏仅供娱乐，严禁赌博，如发现赌博行为，封停账号</a></li>
       <li><a href="#">本游戏仅供娱乐，严禁赌博，如发现赌博行为，封停账号</a></li>
        <li><a href="#">本游戏仅供娱乐，严禁赌博，如发现赌博行为，封停账号</a></li>
    </ul>
  </div>
 ...
 <div class="yinying"></div>
  ...
  <div class="roomCard1">
  <img src="/app/img/public/roomCard.png"> 
  <div class="num" id="fknum">--</div>
   <p style="position:fixed;z-index:100;margin-left:35vw;margin-top:-1vw;" class="chongzhi">
     <img src="/app/chongzhibtn.png" style="height: 28px;">
    </p>
   </div>
  <div class="gameTitle" style="" id="topname"> </div>
<a href='/index.php/portal/user/index'>
      <div id="div1" class="red-border"><img 

src='/static/AEAA7CF9_hpicon.png' style='width:32px;'></div>
      </a>
