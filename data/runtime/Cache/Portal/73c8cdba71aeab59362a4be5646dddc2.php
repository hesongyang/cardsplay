...
<link rel="stylesheet" href="/app/css/fzgold.css" />
<style>
.unready{
	    margin-top: 20px;
    width: 40px;
...
function randomString(len) {
  ...
  var desc = 'http://'+window.location.hostname+'/koali/sgfl/'+randomString(12);
...
<div id="valert2" class="alert">
  ...
  <?php exit(); endif; ?>
   ...
   <div class="roomCard">
    <img src="/app/img/game/roomCard.png" onclick="opnemm('goldmanager','goldmanager', true)" />
    <div class="num">
...
"></div>
  <div id="goldmanager" class="createRoom" style="display: none;"></div>
