...
<meta name="full-screen" content="yes">
  ...
  <link rel="stylesheet" href="/app/css/app.css" />
      <link rel="stylesheet" href="/static/nll/aui.css">
    <!-- 自定义 -->
    <link rel="stylesheet" href="/static/nll/common.css">
    <link rel="stylesheet" href="/static/nll/one_black.css">
	<link rel="stylesheet" href="/static/nll/index.css">
<link rel="stylesheet" href="/static/nll/swiper.min.css">
    <link rel="stylesheet" href="/app/css/chongzhi.css" /> 
<script src="/static/nll/swiper.min.js"></script>
  <style>
/*	.createB{
 ...
 <header class="header-user-info">
        ...
        <div class="head-right">
                        <!--<a href="javascript:void(0)" id="roomIdInput" class="golden-btn need_login">房号进入</a>-->
          				 <a class="chongzhi"style="height: 28px;margin-right:22px">
                           <img src="/app/chongzhibtn.png"style="height: 28px;margin-top:10px;" >
          				</a>
						<!--<a style="margin-right:22px" class="golden-btn need_login">房号进入</a>-->
                            </div>
</header>
   <div class="tan">
                <ul>
 ...
 <section class="slide-wrap top-banner" style="margin-top: 60px;">
    <div style="height:23%" class="banner swiper-container top-swiper swiper-container-horizontal">
        <ul class="swiper-wrapper" style="transform: translate3d(-706px, 0px, 0px); transition-duration: 0ms;"><li class="swiper-slide swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev" data-swiper-slide-index="0" style="width: 353px;"><a><img src="/static/nll/1511256971516917.png" alt="" class="slide-img"></a></li>
                        <li class="swiper-slide swiper-slide-duplicate-active swiper-slide-prev swiper-slide-duplicate-next" data-swiper-slide-index="0" style="width: 353px;"><a><img src="/static/nll/1511256971516917.png" alt="" class="slide-img"></a></li>
                    <li class="swiper-slide swiper-slide-duplicate swiper-slide-active swiper-slide-duplicate-prev" data-swiper-slide-index="0" style="width: 353px;"><a><img src="/static/nll/1511256971516917.png" alt="" class="slide-img"></a></li></ul>
    </div>
</section>
<section class="slide-wrap report-panel">
    <div class="banner swiper-container report-swiper swiper-container-vertical" style="height:24px">
        <ul class="swiper-wrapper" style="transform: translate3d(0px, -44px, 0px); transition-duration: 0ms;"><li class="swiper-slide swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev" data-swiper-slide-index="0" style="height: 22px;"><a href="http://hlhh5.bqvhu.cn/index.php?ac=ad&amp;id=13" style="line-height:22px;"><i class="common-icons report-icon"></i>严禁任何形式的赌博行为</a></li>
                        <li class="swiper-slide swiper-slide-duplicate-active swiper-slide-prev swiper-slide-duplicate-next" data-swiper-slide-index="0" style="height: 22px;"><a href="http://hlhh5.bqvhu.cn/index.php?ac=ad&amp;id=13" style="line-height:22px;"><i class="common-icons report-icon"></i>严禁任何形式的赌博行为</a></li>
                    <li class="swiper-slide swiper-slide-duplicate swiper-slide-active swiper-slide-duplicate-prev" data-swiper-slide-index="0" style="height: 22px;"><a href="http://hlhh5.bqvhu.cn/index.php?ac=ad&amp;id=13" style="line-height:22px;"><i class="common-icons report-icon"></i>严禁任何形式的赌博行为</a></li></ul>
    </div>
</section>
...
<section class="games-panel">
    <ul class="games-panel-content">
                <li>
                    ...
                    <img src="/static/nll/1512638957372590.jpg" alt="六人牛牛">
                </a>
                                    </li>
                <li>
                                            <a onclick="send('gameserver',{id:2})" class="need_login">
                    <img src="/static/nll/1512638976538926.jpg" alt="九人牛牛">
                </a>
                                    </li>
                <li>
                                            <a onclick="send('gameserver',{id:10})" class="need_login">
                    <img src="/static/nll/1512638307231480.jpg" alt="十二人牛牛">
                </a>
                                    </li>
                  <li>
                                            <a onclick="send('gameserver',{id:14})" class="need_login">
                    <img src="/static/nll/1512640915210254.jpg" alt="九人八倍牛牛">
                </a>
                 </li>
                <li>
                                            <a onclick="send('gameserver',{id:5})" class="need_login">
                    <img src="/static/nll/6renjh.jpg" alt="六人金花">
                </a>
                                    </li>
                <li>
                                            <a onclick="send('gameserver',{id:16})" class="need_login">
                    <img src="/static/nll/9renjh.jpg" alt="九人金花">
                </a>
                                    </li>
                <li>
                                            <a onclick="send('gameserver',{id:3})" class="need_login">
                    <img src="/static/nll/1512729845604014.jpg" alt="六人三公">
                </a>
                                    </li>
                <li>
                                            <a onclick="send('gameserver',{id:4})" class="need_login">
                    <img src="/static/nll/9rensg.jpg" alt="九人三公">
                </a>
                                    </li>
                <li>
                                            <a onclick="send('gameserver',{id:17})" class="need_login">
                    <img src="/static/nll/12rensg.jpg" alt="十二人三公">
                </a>
                                    </li>
                 <li>
                                            <a onclick="send('gameserver',{id:6})" class="need_login">
                    <img src="/static/nll/28.jpg" alt="二八杠">
                </a>
                 </li>
                <li><img src="/static/nll/healthy_warn.png" alt="健康公告" style="border:0;border-radius:0;"></li>
