      ...
      ctx.font = "28px 微软雅黑";
        ...
        for(var i=0;i<sj.user.length;i++){
            if(i>1){
                ...
                ctx.fillRect(120,470-(0-(i-1)*82),561,75);
            }
            var user=sj.user[i];
            console.log(user)
            ctx.font = "31px bolder 微软雅黑";
            ctx.fillStyle = "#d8cb66";
            ctx.fillText(user.nickname.substring(0,8), 225, 445+(i*80));
            if(user.dqjf>0){
                user.dqjf='+'+user.dqjf;
            }else{
                ctx.fillStyle = "#fff";
                ctx.fillText(user.nickname.substring(0,8), 225, 445+(i*80));
                ctx.fillText(user.dqjf,  531, 445+(i*80));
            }
            ctx.fillText(user.dqjf,  531, 445+(i*80));
        }
        ...
        ctx.drawImage(img1,120,385-(0-(ying*84)),70,80)
